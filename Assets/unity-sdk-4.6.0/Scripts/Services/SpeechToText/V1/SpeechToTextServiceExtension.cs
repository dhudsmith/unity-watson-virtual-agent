...
namespace IBM.Watson.SpeechToText.V1
{
    public partial class SpeechToTextService : BaseService
    {
        ...
        /// <summary>
        /// Callback URL to process stt results
        /// </summary>
        ...
        private bool CreateListenConnector()
        {
            if (_listenSocket == null)
            {
                ...
                String args = "?model=" + UnityWebRequest.EscapeURL(_recognizeModel) + parsedParams;
                Debug.Log(args);             

                _listenSocket = WSConnector.CreateConnector(Authenticator, "/v1/recognize", args, serviceUrl);                
        ...
        private void SendStart()
        {
            ...
            if (CallbackUrl != null)
                start["callback_url"] = CallbackUrl;
